...
<YYINITIAL> "string"                {return new Symbol(yytext(), 1);}
...
<YYINITIAL> "foreach"               {return new Symbol(yytext(), 1);}
<YYINITIAL> "float"                 {return new Symbol(yytext(), 1);}
<YYINITIAL> "in"                    {return new Symbol(yytext(), 1);}
...
<YYINITIAL> "bool"                  {return new Symbol(yytext(), 1);}
...
<YYINITIAL> "new"                   {return new Symbol(yytext(), 1);}
<YYINITIAL> "true"                  {return new Symbol(yytext(), 1);}
<YYINITIAL> "record"                {return new Symbol(yytext(), 1);}
<YYINITIAL> "repeat"                {return new Symbol(yytext(), 1);}
<YYINITIAL> "until"                 {return new Symbol(yytext(), 1);}
<YYINITIAL> "function"              {return new Symbol(yytext(), 1);}
<YYINITIAL> "println"               {return new Symbol(yytext(), 1);}
<YYINITIAL> "false"                 {return new Symbol(yytext(), 1);}

<YYINITIAL>{

/* identifiers */
{Identifier}                        {return new Symbol(yytext(), 2);}
{other}                             {return new Symbol(yytext(),11);}
/* literals */
